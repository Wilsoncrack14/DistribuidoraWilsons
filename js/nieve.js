//Add-PnPJavaScriptBlock -Name $customerUserActionName -script $scriptBlockForLoader -Scope Site
$scriptBlockForLoader = "var loaderTag = document.createElement('script');loaderTag.type='text/javascript';loaderTag.src='${jsLoaderUrl}?rev='+Math.floor(Date.now()/1000/60);document.getElementsByTagName('head')[0].appendChild(loaderTag)";
// Numero de copos, recomendados entre 30 y 40

var nieve_cantidad = 70;

// Colores de los copos se mostraran de forma aleatoria
var nieve_colorr = new Array("#aaaacc", "#ddddFF", "#ffffff")
